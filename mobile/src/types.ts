// -----------------------------------------------------------------------------
// types.ts — TypeScript shapes shared across the mobile app
// -----------------------------------------------------------------------------
// These mirror the data coming back from our backend server (exactly the same
// as the web app). Defining them once means the editor can auto-complete field
// names and catch typos for us.
