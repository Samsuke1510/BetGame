...
// (Europe/Paris) — the Intl API handles the conversion for us, including
// summer/winter time changes. Works in the browser (Expo web) and on modern
// React Native's JavaScript engine too.
